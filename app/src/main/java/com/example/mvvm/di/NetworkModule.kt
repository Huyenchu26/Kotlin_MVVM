...
import com.example.mvvm.data.repository.LoginRepositoryImpl
...
import com.example.mvvm.util.Constants.BASE_URL
...
class NetworkModule {
    ...
    fun provideLoginRepository(
        ...
        return LoginRepositoryImpl(appDatabase, iLoginApi, provideIsNetworkAvailable(application))
    }
}